...
# Same Degular font file used by ons-dashboard/poc-dashboard, embedded the same
...
__FONT_FACE__
:root {
  /* Palette matched to ons-dashboard/poc-dashboard's tokens so every
     GasBrazil.com dashboard reads as one visual family. */
...
<header>
  ...
  <div class="header-right">
    <div class="header-links">
      ...
      <a class="navlink" id="link-poc-results" href="https://poc.gasbrazil.com">POC Results Dashboard &rarr;</a>
...
// This same built HTML file may be published to more than one place at once
// (custom domain plus GitHub Pages / hub mirror URLs), so the cross-links
...
function initCrossLinks() {
  ...
  document.getElementById("link-poc-results").href = SITE_LINKS.pocResults[flavor];
}
...
// Same sun/moon icon markup as ons-dashboard/poc-dashboard -- the icon shown
// is the mode a click switches TO, matching that dashboard's convention.
